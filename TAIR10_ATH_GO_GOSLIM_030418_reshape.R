...
GOann <- read.table(file = "/projects/ajt200/TAIR10/TAIR10_ATH_GO_GOSLIM_030418_geneID_GOann.txt", header = F)
...
write.table(GOannReshapedDF, "/projects/ajt200/TAIR10/TAIR10_ATH_GO_GOSLIM_030418_geneID_GOann_reshaped.txt",
