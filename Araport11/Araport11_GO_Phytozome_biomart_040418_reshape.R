...
GOann <- read.table(file = "/projects/ajt200/TAIR10/Araport11/Araport11_GO_Phytozome_biomart_040418_geneID_GOann.txt", header = F)
...
write.table(GOannReshapedDF, "/projects/ajt200/TAIR10/Araport11/Araport11_GO_Phytozome_biomart_040418_geneID_GOann_reshaped.txt",
